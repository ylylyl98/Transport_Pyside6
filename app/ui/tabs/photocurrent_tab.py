...
class PhotocurrentTab(BaseMeasurementTab):
    ...
    def _build_control_panel(self, ctl_layout: QtWidgets.QVBoxLayout):
        ...
        apply_tooltip("Ramp speed used when changing the Vds bias.", lbl_vds_ramp, self.sp_vds_ramp)
        ...
        apply_tooltip("Ramp speed for manual gate changes.", lbl_vg_ramp, self.sp_vg_ramp)
